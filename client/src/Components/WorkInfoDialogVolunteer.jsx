...
import { Box, Dialog, DialogTitle, DialogContent, Button , Divider} from "@mui/material";

export default function WorkInfoDialogVolunteer({ dialogOpen, selectedWork, handleDialogClose, handlePostulation }) {
    return (
